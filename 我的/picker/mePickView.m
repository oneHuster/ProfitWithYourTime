...
-(void)addView{
    ...
    button.frame = CGRectMake(SCREEN_WIDTH-60,0, 60, 35);
...
-(void)selectjia{
    ...
    [self.delegate selectProvince:[self.provinceArray objectAtIndex:[self.pickerView selectedRowInComponent:0]] City:[self.cityArray objectAtIndex:[self.pickerView selectedRowInComponent:1]] andDis:[self.townArray objectAtIndex:[self.pickerView selectedRowInComponent:2]]];
}
