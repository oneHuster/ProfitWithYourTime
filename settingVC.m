...
@interface settingVC()<UITableViewDataSource,UITableViewDelegate,VPImageCropperDelegate,UIImagePickerControllerDelegate, UIActionSheetDelegate,UINavigationControllerDelegate,UIPickerViewDataSource,UIPickerViewDelegate,UITextFieldDelegate>{
    NSArray *titleList;
...
- (UITableViewCell*)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    [cell loadModelWithTitle:titleList[indexPath.section+indexPath.row] AndItem:modelList[indexPath.row+indexPath.section]];
    return cell;
}
